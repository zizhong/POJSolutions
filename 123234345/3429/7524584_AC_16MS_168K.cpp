...
{
      Point p0;p0.x= ((p3.y-p1.y)*(p4.x-p3.x)*(p2.x-p1.x)-(p4.y-p3.y)*(p2.x-p1.x)*p3.x
                  +(p2.y-p1.y)*(p4.x-p3.x)*p2.x)/((p2.y-p1.y)*(p4.x-p3.x)-(p4.y-p3.y)*(p2.x-p1.x));
      if(p2.x==p1.x)
             p0.y=(p4.y-p3.y)*(p0.x-p3.x)/(p4.x-p3.x)+p3.y;
      else
          p0.y=(p2.y-p1.y)*(p0.x-p1.x)/(p2.x-p1.x)+p1.y;
      return p0;
}*/
