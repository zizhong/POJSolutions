...
const int maxn=1010;
int dis[maxn];
int fir1[maxn],next1[maxn*100],to1[maxn*100],len1[100*maxn];
int fir2[maxn],next2[maxn*100],to2[maxn*100],len2[100*maxn];
int s,target,k,d;
...
int Astar()
{
    ...
    while(q2.empty()==0)
    {
         ...
         q2.pop();
         cnt[temp.to]++;
         if(cnt[temp.to]==k) return temp.f;
