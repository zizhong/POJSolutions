...
int  dijkstra(int src,int dist[],int nbs[],int next[],int ev[],int ew[])
{
     for(int i=1;i<=n;i++)
     {
          dist[i]=inf;
...
int main()
{
    ...
    for(scanf("%d",&T);T--;)
    {
         ...
         printf("%d\n", dijkstra(1,dist1,nbs1,next1,ev1,ew1) +
                        dijkstra(1,dist1,nbs2,next2,ev2,ew2));
