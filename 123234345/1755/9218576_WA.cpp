...
int main()
{
    ...
    while(scanf("%d",&n)==1)
    {
         ...
         {
              int nn=3,flag=0; 
         pv[0]=pVector(point(0,10000),point(0,-1));
         pv[1]=pVector(point(0,0),point(10000, 0));
         pv[2]=pVector(point(10000,-9999),point(0, 1));
              for(int i=0;i<n;i++) if(i!=k)
              {
                   double c=10000/peo[k].w - 10000/peo[i].w,
                          a=10000/peo[k].u - 10000/peo[i].u - 10000/peo[k].w + 10000/peo[i].w,
                          b=10000/peo[k].v - 10000/peo[i].v - 10000/peo[k].w + 10000/peo[i].w;
                   ...
                   {
                         p1=point(-c/a,0),p2=point(-c/a,10000);
                         if(sgn(a)>0) pv[nn++]=pVector(p1,p2);
                         else pv[nn++]=pVector(p2,p1);
                   }else
                   {
                         p1=point(0,-c/b),p2=point(10000,(-c-10000*a)/b);
